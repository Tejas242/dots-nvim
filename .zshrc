...
PROMPT_ALTERNATIVE=twoline # oneline, twoline or backtrack
...
__conda_setup="$('/home/screenager/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/screenager/miniconda3/etc/profile.d/conda.sh" ]; then
# . "/home/screenager/miniconda3/etc/profile.d/conda.sh"  # commented out by conda initialize
    else
# export PATH="/home/screenager/miniconda3/bin:$PATH"  # commented out by conda initialize
    fi
fi
unset __conda_setup
